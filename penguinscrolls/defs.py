...
DEFAULT_DATASET_NAME = (
    "penguin_scrolls"  # Default name of the dataset if not specified in environment
)
DATASET_NAME = os.environ.get(
    "PENGUIN_SCROLLS", DEFAULT_DATASET_NAME
)  # Actual dataset name from env or default
DEFAULT_SPLIT = "test"  # Default dataset split to use (e.g., train/test/validation)
PENGUIN_EVAL_MODEL = os.environ.get(
    "PENGUIN_EVAL_MODEL", "gpt-4o"
)  # Model used for evaluation, from env or default

INPUT_COL = "input"  # Column name for the input data
KEY_COL = "input_md5"  # Column name for MD5 hash of input (used as unique identifier)
QUESTION_COL = "prompt"  # Column name for the question/prompt text
ANSWER_COL = "output"  # Column name for the expected answer/output
